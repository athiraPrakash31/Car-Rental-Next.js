    ...
    return (
        <>
            <div className={styles.searchBackground}>
                <Image className={styles.image} src={Banner} alt="search-background" width={1280} height={227} />
                <div className={styles.breadcrumb}>
                    <ul>
                        <li><a href="" onClick={() => setIsActive(false)}>Same as Pick-Up</a></li>
                        <li><a href="" onClick={handleClick}>Different Drop-Off</a></li>
                        <li>
                    ...
                    {isActive ? (
                            <>
                                <input type="text" placeholder="Al Quao" className={styles.input} />
                                <input type="text" placeholder="Al Quao" className={styles.input} />
                            </>
                        ) : (
                            <input type="text" placeholder="Al Quao" className={styles.input} />
                        ...
                        <div className={styles.datetimewrapper}>
                            <input type="datetime-local" id="datetime-input" className={styles.input} />
                            <input type="datetime-local" id="datetime-input" className={styles.input} />
                        </div>
                    ...
                    <div className={styles.download}>
                        ...
                        <Image src={GoogleStore} alt="google-store" width={0} height={30} />
                        </div>
                    </div>
                </div>
            </div>
